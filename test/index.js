...
const lib = require('..');
const { AddressTypes, BaseAddressTypes } = lib;

const sampleWalletMnemonicV1 =
  'logic easily waste eager injury oval sentence wine bomb embrace gossip supreme';
const sampleWalletMnemonicV2 =
  'cost dash dress stove morning robust group affair stomach vacant route volume yellow salute laugh';
const sampleRootKeypairV1 = Buffer.from(
  '',
  'hex'
);
const sampleRootKeypairV2 = Buffer.from(
...
const sampleHdPassphrase = Buffer.from(
  'c582f8e7cf7aeb6e5f3e96e939a92ae1642360a51d45150f34e70132a152203f',
  'hex'
);
const sampleMessage = Buffer.from('Hello world', 'utf-8');
const sampleRightSignature = Buffer.from(
...
const sampleWrongSignature = Buffer.from(
  '2096ddcfb2ad21a4c0d861ef3fabe18841e8de88105b0d8e36430d7992c588634ead4100c33b2800b31b65e014d54a8238bdda63118d829bf0bcf1b631e86f0e',
  'hex'
);
const sampleHardenedIndex = 0x80000001;
const sampleHardenedChildKeyMode1 = Buffer.from(
  '',
  'hex'
);
const sampleHardenedChildKeyMode2 = Buffer.from(
  '',
  'hex'
);
const sampleNonhardenedIndex = 1;
const sampleNonHardenedChildKeyMode1 = Buffer.from(
  '30c87a45fe4a8f143478db0d8db6cf963bdfb559f2a050fceae40bc7e97333f832635e6d3dd3409b00373d4f9b49eb8e9444a4ea8e380397e9711a95b940ecd7',
  'hex'
);
const sampleNonHardenedChildKeyMode2 = Buffer.from(
  '19ad2602cee521db72c4ad41c2daf36ca46cf8e80733822fa0f79c8013de8e6fed4f3181d9f544612c5f15e01db0745111b8ee7fc87b784ee083ad314e094662',
  'hex'
);
...
const sampleDecodedPaperWalletMnemonic =
  'swim average antenna there trap nice good stereo lion safe next brief';
const sampleV1Address =
  'DdzFFzCqrhssmYoG5Eca1bKZFdGS8d6iag1mU4wbLeYcSPVvBNF2wRG8yhjzQqErbg63N6KJA4DHqha113tjKDpGEwS5x1dT2KfLSbSJ';
const sampleV1AddressBuf = Buffer.from(
  '82d818584283581c6aebd89cf88271c3ee76339930d8956b03f018b2f4871522f88eb8f9a101581e581c692a37dae3bc63dfc3e1463f12011f26655ab1d1e0f4ed4b8fc63708001ad8a9555b',
  'hex'
);
...
const sampleBaseAddress =
  'addr1qz2fxv2umyhttkxyxp8x0dlpdt3k6cwng5pxj3jhsydzer3jcu5d8ps7zex2k2xt3uqxgjqnnj83ws8lhrn648jjxtwqcyl47r';
const sampleBaseAddressBuf = Buffer.from(
  '009493315cd92eb5d8c4304e67b7e16ae36d61d34502694657811a2c8e32c728d3861e164cab28cb8f006448139c8f1740ffb8e7aa9e5232dc',
  'hex'
);
const sampleScriptAddress =
  'addr_test1zqf8ysutwtlp0d25y5crls407s4wv9rs5vd82nr648um5e968m5cqvlnrhd7g8qlwu6vc59l6kcur8ycdv8z38ekat0qdk8pr8';
const sampleScriptAddressBuf = Buffer.from(
  '101272438b72fe17b55425303fc2aff42ae61470a31a754c7aa9f9ba64ba3ee98033f31ddbe41c1f7734cc50bfd5b1c19c986b0e289f36eade',
  'hex'
);
const sampleEnterpriseScriptAddress = 'addr_test1wqf8ysutwtlp0d25y5crls407s4wv9rs5vd82nr648um5eql2052n';
const sampleEnterpriseScriptAddressBuf = Buffer.from(
  '701272438b72fe17b55425303fc2aff42ae61470a31a754c7aa9f9ba64',
  'hex'
);
...
test('signing', (t) => {
  ...
  t.equals(signature.toString('hex'), sampleRightSignature.toString('hex'), 'signing works properly');
});
...
test('sha3_256', (t) => {
  ...
  const message = Buffer.from(
    '83008200584078732eb9d33e03b3daab4a4613bc19b8820ef5911caf43785780ec6493653bf67115f7f2c460be13dcc09f06f3d63fffe05a3d12996e5224e189a41ee2ef5c95a101581e581c140539c64edded60a7f2d869373e87e744591935bfcdadaa8517974c',
    'hex'
  );
...
test('chacha20poly1305', (t) => {
  ...
  const expectedEncryptionResult = Buffer.from(
    '140539c64edded60a7f2d9696b17a78b4494b6bf0eef0cc28cad3c2b',
    'hex'
  );
...
test('cardanoMemoryCombine', (t) => {
  ...
  const input = Buffer.from(
    '41227237bcfda3c7b921225e5d883eb7fdbd14935ebe897f5951769a0bc735bdfa3b548357e19f27d59053bfa22f415f8f5d55bfe031bfe2946a4725f3cdfa3c',
    'hex'
  );
  const password = 'WalletS3cret';
  const expectedOutput = Buffer.from(
    '80a93f1b0c558631f9473c0169dda414535caefa1a9b4a7a29b41f0d96b4aa4359eafca30ae2726745155a8034c671786984d65b9ac11f850447e3884267801c',
    'hex'
  );
...
test('scrypt', (t) => {
  ...
  t.equals(key, sampleScryptDerivedKey, 'should properly derive key by scrypt');
});
...
test('bootstrap address validation', async (t) => {
  t.plan(4);
  t.equals(lib.isValidBootstrapAddress(sampleV1Address), true, 'should accept V1 address');
  t.equals(lib.isValidBootstrapAddress(sampleV2Address), true, 'should accept V2 address');
  t.equals(
  ...
  t.equals(lib.isValidBootstrapAddress(sampleRandomString), false, 'should reject random string');
});

test('Shelley address validation', async (t) => {
  t.plan(3);
  t.equals(lib.isValidShelleyAddress(sampleBaseAddress), true, 'should accept Shelley base address');
  t.equals(lib.isValidShelleyAddress(sampleV1Address), false, 'should reject bootstrap address');
  t.equals(lib.isValidShelleyAddress('garbage'), false, 'should reject arbitrary string');
});

test('script address validation', async (t) => {
  t.plan(3);
  t.equals(
    lib.hasSpendingScript(lib.addressToBuffer(sampleBaseAddress)),
    false,
    'should reject pubkey address'
  );
  t.equals(
    lib.hasSpendingScript(lib.addressToBuffer(sampleScriptAddress)),
    true,
    'should accept base script address'
  );
  t.equals(
    lib.hasSpendingScript(lib.addressToBuffer(sampleEnterpriseScriptAddress)),
    true,
...
test('bootstrap address packing/unpacking', async (t) => {
  ...
  const expectedV1MainnetAddress =
    'DdzFFzCqrhtBwFyaWje9HStKDWNwWBghBDxGTsnaxoPBE4pZg3pvZC1zDyMpbJqZ7XxpVcHoYc5TA8oA8Hc8gJPUY2kAsaNGW6b8KrrU';
  const expectedV1TestnetAddress =
    '2RhQhCGqYPDqLvKWTmnNBHFFUSeMTfdfogpmJMWQE6gmn1bSMiL3ji6Dkjb3YX7UdtaeFSHZBQLKJnPmABFDhp3L2hxvFtPCskG3ep8VpxL1gV';
  ...
  t.equals(
    lib.getBootstrapAddressAttributes(lib.addressToBuffer(expectedV1MainnetAddress)).size,
    1,
    'should properly get Daedalus bootstrap address attributes'
  );
  t.equals(
    lib.getBootstrapAddressAttributes(lib.addressToBuffer(expectedV2MainnetAddress)).size,
    0,
    'should properly get Icarus bootstrap address attributes'
  );
  t.equals(
    lib.getBootstrapAddressAttributes(lib.addressToBuffer(expectedV1TestnetAddress)).size,
    2,
    'should properly get Daedalus bootstrap address attributes'
  );
  t.equals(
    JSON.stringify(
      lib.getBootstrapAddressDerivationPath(lib.addressToBuffer(expectedV1TestnetAddress), sampleHdPassphrase)
    ),
    JSON.stringify(derivationPath),
    'should properly get Daedalus bootstrap address derivation path'
  );
  t.equals(
    lib.getBootstrapAddressDerivationPath(lib.addressToBuffer(expectedV2MainnetAddress), sampleHdPassphrase),
    null,
    'should properly get Icarus bootstrap address derivation path'
  );
  t.equals(
    lib.getBootstrapAddressProtocolMagic(lib.addressToBuffer(expectedV1MainnetAddress)),
    mainnetProtocolMagic,
    'should properly get Daedalus bootstrap mainnet address protocol magic'
  );
  t.equals(
    lib.getBootstrapAddressProtocolMagic(lib.addressToBuffer(expectedV1TestnetAddress)),
    testnetProtocolMagic,
...
test('shelley addresses', (t) => {
  ...
  const scriptStakingPubKey = Buffer.from(
    'ee2a468c65fd5c2febb1b1f2024eedde097cf3d7df43e0961b5774c1a95ad58c',
    'hex'
  );
  ...
  t.equals(
    lib.packBaseAddress(spendingKeyHash, stakingKeyHash, 3).toString('hex'),
  ...
  t.equals(
    lib.packBaseAddress(scriptHash, scriptStakingHash, 0, BaseAddressTypes.SCRIPT_KEY).toString('hex'),
    sampleScriptAddressBuf.toString('hex'),
