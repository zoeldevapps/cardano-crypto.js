...
export function validateBuffer(input: unknown, expectedLength?: number): asserts input is Buffer {
...
export function validateDerivationIndex(input: unknown): asserts input is number {
...
export function validateDerivationScheme(input: unknown): asserts input is 1 | 2 {
  if (input !== 1 && input !== 2) {
